...
import com.devtests.pruebatecnica.databinding.FragmentDetailsListBinding
...
class DetailsListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val rootView = inflater.inflate(R.layout.fragment_details_list, container, false)
        ...
        if (parametros != null) {
            //val valor = parametros.getString("clave")
            val valor1 = parametros.getString("donut")
            //binding.txtTile.text = valor
            binding.txtTile.text = valor1
